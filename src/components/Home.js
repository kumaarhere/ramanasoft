          ...
          <div>
            <div>
              ...
              <div className='d-flex justify-content-center mt-4'>
                <button className='btn btn-info px-5 rounded shadow fw-bold text-white'><a href='https://qtinternship.com/jobs_search/index.php' target='_blank' className='text-decoration-none text-white vacancy'>View Job Vacancies.</a></button>
              </div>
            </div>
          </div>
        </div>
